...
* Customize the request details:
  * **HTTP Method:** Change between `GET`, `POST`, `PUT`, `DELETE`, etc.
  * **URL:** Update the endpoint path or query parameters.
...
* You will automatically be redirected to the **Response Page** to view the results:
  * **Status:** Displays the HTTP status code (e.g., `200 OK`, `404 Not Found`).
  * **Body:** Shows the returned data payload.
